...
public interface UserRepository extends PagingAndSortingRepository<User, Long> {
    ...
    @Query(value = "select u.* from user_role inner join \"user\" u on user_role.user_id = u.id where user_role.role = :userRole and u.command_id is null", nativeQuery = true)
